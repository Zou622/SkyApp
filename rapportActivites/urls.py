...
urlpatterns = [
    ...
    path('rapport/<int:rapport_id>/valider/', views.valider_rapport, name='valider_rapport'),
    path('activite/<int:activite_id>/demarrer/', views.commencer_activite, name='commencer_activite'),
