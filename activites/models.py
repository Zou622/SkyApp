...
class Champrapport(models.Model):
    nomChamp = models.CharField(max_length=100)
    typeActivites = models.CharField(max_length=100)  # correspond au type d'activité choisi
    TYPE_CHOICES = [
        ('texte', 'Texte'),
        ('nombre', 'Nombre'),
        ('date', 'Date'),
    ...
    typeChamp = models.CharField(max_length=20, choices=TYPE_CHOICES, default='texte')

    def __str__(self):
        return f"{self.nomChamp} — {self.typeActivites}"